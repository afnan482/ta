...
<head>
    ...
    .navbar-nav .dropdown-toggle {
        padding-right: 5px; /* Mengurangi jarak antara ikon dan panah */
    }

    .navbar-nav .dropdown-toggle i.fa-user {
        margin-right: -5px; /* Menggeser ikon user ke kiri */
    }
    </style>
</head>
            ...
            <main>
                <div class="container-fluid px-4">
                    ...
                    <div class="card mb-4">
                        ...
                        <form class="ms-3" method="post" action="proses_simpan.php" enctype="multipart/form-data">
                            <div class="row mb-3">
                            ...
                            <button type="submit" class="btn btn-primary mb-3" data-bs-toggle="tooltip" title="Simpan">Simpan</button>
                            <button type="reset" class="btn btn-danger mb-3" data-bs-toggle="tooltip" title="Reset">
